...
/*
 ...
 @params fileHashes 16진수 문자열 vector
 @returns MerkleNode 구조체타입 루트노드
*/
...
/*
  특정 디렉토리의 모든 파일들에 대한 해시값과 파일들에 대한 머클트리 루트 노드 해시값 출력
  @param directoryPath 파일들의 해시값과, 머클트리 루트노드를 만들 디렉토리
  @param currentFileHash 디렉토리경로의 모든 파일에 대한 파일이름과, 변경시간을 담은 map
*/
...
*/
void compareMerkleTreeRootNode() {
